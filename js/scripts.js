...
function logOut(){
    ...
    $.ajax({ 
        ...
        success:function(data){
            ...
            if(data.indexOf("false") != -1){
                mensaje = "No se pudo cerrar tu sesión, inténtalo de nuevo.";
            }
...
function addProductToCart(id_product){
    ...
    $.ajax({ 
        ...
        success:function(data){
            ...
            if(data.indexOf("true") != -1){
                mensaje = "Se agregó el producto a tu carrito.";
                size = "none";
                updateCart();
            }
...
function deleteProductFromCart(unique_id){
    ...
    $.ajax({ 
        ...
        success:function(data){
            ...
            if(data.indexOf("true") != -1){
                mensaje = "Se eliminó el producto a tu carrito.";
                updateCart();
                $('#'+unique_id).remove();
            }
...
function addWishlist(id_product){
    ...
    $.ajax({ 
        ...
        success:function(data){
            ...
            if(data.indexOf("true") != -1){
                mensaje = "Se agregó el producto a tu wishlist.";
                updateWishlist();
            }
