	...
	switch($success){
		...
		case '1':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha creado correctamente el impuesto.
					  </div>';	
		break;
		case '2':
			$alert = '<div class="alert alert-success alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha modificado correctamente el impuesto.
					  </div>';	
		break;
		case '3':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha eliminado correctamente el(los) impuesto(s).
					  </div>';	
		break;
		case '4':
			$alert = '<div class="alert alert-info alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha activado correctamente el(los) impuesto(s).
					  </div>';	
		break;
		case '5':
			$alert = '<div class="alert alert-warning alert-dismissable">
  						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
  						<strong>¡MUY BIEN!</strong> Se ha desactivado correctamente el(los) impuesto(s), cuando desactiva elementos estos no se muestran en la parte principal de la página.
					  </div>';	
		break;				
	}
}
...
$temporal = new impuesto();
$lista_impuestos = $temporal -> listar_impuestos();
$clave='AgrImp';
$clave2='ElimImp';
$clave3='AcDcImp';
$clave4='SortTableImp';
...
?>
	<title>Listado De Los Impuestos</title>
<?php
                ...
                <div class="row rowedit">
                  ...
                  <div class='notifications bottom-right'></div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <p class="titulo">Impuestos</p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    	<form action="formimpuesto.php" method="post">
                    ...
                    <div class="styled-large">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <ul class="ulfiltros">
                                ...
                                <li class="lifiltros">    
                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operaimpuesto">Aplicar</button>
                                </li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
              						foreach($lista_impuestos as $impuest_tmp)
              						{ 
              							if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)!=0){
              								
              						 echo'<tr>
                                	<td>
                                  	<input type="checkbox" id="'.$impuest_tmp['id_impuesto'].'" name="id_impuesto[]" value="'.$impuest_tmp['id_impuesto'].'">
  									                <label for="'.$impuest_tmp['id_impuesto'].'"><span></span></label>
                                  </td>
                                  <td><a href="formimpuesto.php?id_impuesto='.$impuest_tmp['id_impuesto'].'">'.$impuest_tmp['nombre'].'</a></td>
                                  <td>'.$impuest_tmp['porcentaje'].'</td>                                               
                                </tr>';
              						}
                        }
                      ?>
