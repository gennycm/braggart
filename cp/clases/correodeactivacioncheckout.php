...
class correodeactivacioncheckout extends correo
{
    var $userend;
    var $datosuserend;
    var $path  = "http://clientes.locker.com.mx/notmonday/";

    function correodeactivacioncheckout($iduserend)
    {    
        $this->correo();
        $this->userend = new userend($iduserend);
    ...
    {
        $this->correo->Subject='Registro NotMonday';
    }
                        ...
                        <tr>
                            <td align="center" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                    <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Registro NOTMONDAY</span>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                ...
                                                <span style="color:#777">
                                                    Hola '.$this->userend->datosuserend->nombre.' '.$this->userend->datosuserend->apellido.'
                                                    <span style="color:#333"><strong>Nombre de usuario:</strong> '.$this->userend->correo.'</span><br />
                                                    <span style="color:#333">Ahora puede realizar sus compras desde NOTMONDAY; Gracias.</span> <br />
                                                </span>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
