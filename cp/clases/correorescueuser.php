...
class correorescueuser extends correo
{
    var $userend;
    var $datosuserend;
                        ...
                        <tr>
                            <td align="center" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                    <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">RECOVER PASSWORD</span>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                ...
                                                <span style="color:#777">
                                                    ...
                                                    <span style="color:#333"><a href="'.$this->path.'recover.php?notify='.$this->userend->token.'">Recover my password</strong></span> <br />
                                                </span>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
