...
class correodeactivacion extends correo
{
    var $userend;
    var $datosuserend;
    var $path  = "http://clientes.locker.com.mx/notmonday/";

    function correodeactivacion($iduserend)
    {    
        $this->correo();
                        ...
                        <tr>
                            <td align="center" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                    <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Email Account Activation</span>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                ...
                                                <span style="color:#777">
                                                    Hello! '.$this->userend->datosuserend->nombre.' '.$this->userend->datosuserend->apellido.'
                                                    <span style="color:#333"><strong>User Name:</strong> '.$this->userend->correo.'</span><br />
                                                    <span style="color:#333"><a href="'.$this->path.'/controller.php?operaciones=ACU&token='.$this->userend->token.'">Active my account</strong></span> <br />
                                                </span>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
