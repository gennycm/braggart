...
class correodeactivacion extends correo
{
    ...
    {
        $this->correo->Subject='BRAGGART Confirmación correo electrónico.';
    }
                ...
                <tr>
                    <td align="center" class="titleblock" style="padding:7px 0">
                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                            <span class="subtitle" style="font-weight:500;font-size:16px;line-height:25px">Confirmación de correo electr&oacute;nico</span>
                        </font>
                    </td>
                </tr>
                <tr>
                                        ...
                                        <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:15px;padding-bottom:10px">
                                            Detalles del mensaje:</p>
                                                <span style="color:#777">
                                                    ...
                                                    <span style="color:#333"><strong>Bienvenido a BRAGGART, este correo es para que confirmes que la direcci&oacute;n de correo electrónico que registraste es suya.</strong></span><br />
                                                </span>
                                    </font>
                                </td>
