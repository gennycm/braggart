                        ...
                        <tr>
                            <td align="center" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                    <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">Datos Orden</span>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                ...
                                                <span style="color:#777">
                                                    ...
                                                    <span style="color:#333"><strong>Tu orden ha sido generada con éxito.</strong></span><br />
                                                </span>
                                                <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:18px;padding-bottom:10px">
                                                    Datos de la orden:</p>
                                                <span style="color:#777">
                                                    <span style="color:#333"><strong>Folio: </strong>'.$this->orden->idorden.'</span><br />
                                                    ...
                                                    <span style="color:#333"><strong>Estado de la orden: </strong>En espera</span><br />
                                                </span>
                                                <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;text-transform:uppercase;font-weight:500;font-size:12px;padding-bottom:10px">
                                                    Pronto nos pondremos en contacto con usted ¡gracias por su compra!.</p>    
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
                                    </tr>
