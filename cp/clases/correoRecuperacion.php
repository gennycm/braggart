...
class correoRecuperacion extends correo
{
    ...
    {    
        $this->correo();
        $this->usuario = new userend($idusuario);
        $this->usuario -> obten_userend();        
    }
    
    function genera_asunto()
    {
        $this->correo->Subject='Recuperación de contraseña Braggart | MADE FOR ME';
    }
    
    function genera_destino()
    {
        $this->correo->AddAddress($this->usuario->correo);
    }
                                                        ...
                                                        <tr>
                                                            <td align="center" class="titleblock" style="padding:7px 0">
                                                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                                                    <span class="subtitle" style="font-weight:500;font-size:16px;line-height:25px">Recuperación de Contraseña</span>
                                                                </font>
                                                            </td>
                                                        </tr>
                                                        <tr>
