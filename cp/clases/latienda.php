...

{
	...
	function latienda($id_latienda = 1, $descripcion1 = "", $descripcion2 = "", $descripcion3 = "")
	{
	...
	{	
		$sql="UPDATE latienda SET descripcion1 = '".htmlspecialchars($this -> descripcion1)."', descripcion2 = '".htmlspecialchars($this -> descripcion2)."'  ,descripcion3 = '".htmlspecialchars($this -> descripcion3)."' WHERE id_latienda = ".$this -> id_latienda.";";
		$con= new conexion();
