...
class correosuccess extends correo
{
    var $userend;
    var $datosuserend;
    var $path  = "http://clientes.locker.com.mx/notmonday/";

    function correosuccess($iduserend)
    {    
        $this->correo();
    ...
    {
        $this->correo->Subject='Email successfully recover password NotMonday';
    }
                        ...
                        <tr>
                            <td align="center" class="titleblock" style="padding:7px 0">
                                <font size="2" face="Open-sans, sans-serif" color="#555454">                                    
                                    <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:uppercase;line-height:25px">RESET PASSWORD</span>
                                </font>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="padding:7px 0">
                                            <font size="2" face="Open-sans, sans-serif" color="#555454">
                                                ...
                                                <span style="color:#777">
                                                    Hello! '.$this->userend->datosuserend->nombre.' '.$this->userend->datosuserend->apellido.' </br>
                                                    <span style="color:#333"><strong>Your password has been reset successfully.</strong></span><br />
                                                </span>
                                            </font>
                                        </td>
                                        <td width="10" style="padding:7px 0">&nbsp;</td>
